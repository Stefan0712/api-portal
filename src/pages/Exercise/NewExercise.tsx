                ...
                <form className="flex gap-[10px] p-[20px]">
                    <div className="w-1/2 flex flex-col gap-[10px]">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col gap-2 h-[150px] overflow-x-hidden overflow-y-auto primary-color rounded p-2">
                    ...
                    <div className="w-1/2 flex flex-col gap-[20px]">
                        ...
                        <div >
                            ...
                            <div className="flex flex-col gap-2 h-[150px] overflow-x-hidden overflow-y-auto primary-color rounded mt-2 p-2">
