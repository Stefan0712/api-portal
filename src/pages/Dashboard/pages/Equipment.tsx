    ...
    if(!userId){
        ...
        return ( 
            <div>
                ...
                {showCreateEquipment ? <div className="absolute bottom-[25px] left-1/2 transform -translate-x-1/2 w-1/2 min-w-[400px] max-w-[800px] background-color p-[20px] rounded grid grid-cols-[1fr_1fr] grid-rows-[50px_1fr_50px] gap-[10px]">
                    <div className="col-start-1 col-end-3 row-start-1 row-end-2 flex items-center"><h2 className="font-bold text-xl">Create Equipment</h2><button className="ml-auto" onClick={()=>setShowCreateEquipment(false)}><img src={IconLibrary.Close} className="h-[40px] w-[40px]" /></button></div>
